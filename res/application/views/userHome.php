                    ...
                    <div class="navbar-custom-menu left-sdide">
                        <ul class="nav navbar-nav">
                            ...
                            <?php if ($this->session->userdata('outlet_id')) { ?>
                                ...
                                if ($this->session->userdata('role') == "Admin" && strripos( ($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']),'restaurant.socialbat.net/Authentication')!==FALSE) { ?>
                                    <li class="dropdown user user-menu">
                                        <a href="#" onclick="lowinventorydata();" class="dropdown-toggle" data-toggle="dropdown">
                                            <i class="fa fa-hdd-o"></i><span class="hidden-xs">Low Inventory (<?php echo count($low_stock_ingredients); ?>)</span>
                                        </a>
                                    </li>
                                    <?php
                                }
            ...
            <footer class="main-footer">  
                <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                        <strong>Innovative</strong>,  Restaurant POS
                        <div class="hidden-lg">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"> <i class="fa fa-warning"></i><?php echo lang('ingredients_alert'); ?>/<?php echo lang('low_stock'); ?> <span style="color: red;">(<?php echo count($low_stock_ingredients); ?>) <span id="opening_closing_register_time"></span></h4>
                    </div>
                    <div class="modal-body" id="inventory_details_body">
